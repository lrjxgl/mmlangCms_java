...
public class WeixinUserController {
	...
	@RequestMapping("/admin/weixin_user/index")
	public String Index() {
	...
	@RequestMapping("/admin/weixin_user/show")
	public String Show(
	...
	@RequestMapping("/admin/weixin_user/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/weixin_user/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("shopid", shopid);
	...
	@RequestMapping("/admin/weixin_user/status")
	...
	@RequestMapping("/admin/weixin_user/recommend")
	...
	@RequestMapping("/admin/weixin_user/delete")
