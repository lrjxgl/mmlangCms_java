...
public class UserAddressController {
	...
	@RequestMapping("/admin/user_address/index")
	public String Index() {
	...
	@RequestMapping("/admin/user_address/show")
	public String Show(
	...
	@RequestMapping("/admin/user_address/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/user_address/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("lng", lng);
	...
	@RequestMapping("/admin/user_address/status")
	...
	@RequestMapping("/admin/user_address/recommend")
	...
	@RequestMapping("/admin/user_address/delete")
