...
import com.deitui.morelang.index.model.OpenAlipayMiniModel;
import com.model.Help;

@RestController
@CrossOrigin("*")
public class OpenAlipayMiniController {
	
	@RequestMapping("/admin/open_alipay_mini/index")
	public String Index() {
		OpenAlipayMiniModel am=new OpenAlipayMiniModel();
		String where=" 1 ";
	...
	@RequestMapping("/admin/open_alipay_mini/show")
	public String Show(
	...
	@RequestMapping("/admin/open_alipay_mini/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/open_alipay_mini/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("merchant_private_key", merchant_private_key);
	...
	@RequestMapping("/admin/open_alipay_mini/status")
	...
	@RequestMapping("/admin/open_alipay_mini/recommend")
	...
	@RequestMapping("/admin/open_alipay_mini/delete")
