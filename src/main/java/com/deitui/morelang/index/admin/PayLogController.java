...
public class PayLogController {
	...
	@RequestMapping("/admin/pay_log/index")
	public String Index() {
	...
	@RequestMapping("/admin/pay_log/show")
	public String Show(
	...
	@RequestMapping("/admin/pay_log/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/pay_log/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("money", money);
	...
	@RequestMapping("/admin/pay_log/status")
	...
	@RequestMapping("/admin/pay_log/recommend")
	...
	@RequestMapping("/admin/pay_log/delete")
