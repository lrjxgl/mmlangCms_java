...
public class GoldLogController {
	...
	@RequestMapping("/admin/gold_log/index")
	public String Index() {
		GoldLogModel am=new GoldLogModel();
		String where=" 1 ";
	...
	@RequestMapping("/admin/gold_log/show")
	public String Show(
	...
	@RequestMapping("/admin/gold_log/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/gold_log/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("money", money);
	...
	@RequestMapping("/admin/gold_log/status")
	...
	@RequestMapping("/admin/gold_log/recommend")
	...
	@RequestMapping("/admin/gold_log/delete")
