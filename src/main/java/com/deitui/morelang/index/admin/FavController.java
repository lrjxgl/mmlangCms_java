...
public class FavController {
	...
	@RequestMapping("/admin/fav/index")
	public String Index() {
		FavModel am=new FavModel();
		String where=" 1 ";
...
indata.put("objectid", objectid);
	...
	@RequestMapping("/admin/fav/status")
	...
	@RequestMapping("/admin/fav/recommend")
	...
	@RequestMapping("/admin/fav/delete")
