...
public class ApppushController {
	...
	@RequestMapping("/admin/apppush/index")
	public String Index() {
	...
	@RequestMapping("/admin/apppush/show")
	public String Show(
	...
	@RequestMapping("/admin/apppush/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/apppush/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("openid", openid);
	...
	@RequestMapping("/admin/apppush/status")
	...
	@RequestMapping("/admin/apppush/recommend")
	...
	@RequestMapping("/admin/apppush/delete")
