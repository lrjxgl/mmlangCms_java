...
import com.deitui.morelang.index.model.AdminModel;
...
public class AdminController {
	...
	@RequestMapping("/admin/admin/show")
	public String Show(
	...
	@RequestMapping("/admin/admin/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
@RequestParam(value="username",defaultValue="") String username,
@RequestParam(value="password",defaultValue="") String password,
@RequestParam(value="salt",defaultValue="0") int salt,
...
indata.put("group_id", group_id);
	...
	@RequestMapping("/admin/admin/status")
	...
	@RequestMapping("/admin/admin/recommend")
