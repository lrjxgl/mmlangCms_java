...
public class OpenWxnativeController {
	...
	@RequestMapping("/admin/open_wxnative/index")
	public String Index() {
	...
	@RequestMapping("/admin/open_wxnative/show")
	public String Show(
	...
	@RequestMapping("/admin/open_wxnative/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/open_wxnative/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("openlogin", openlogin);
	...
	@RequestMapping("/admin/open_wxnative/status")
	...
	@RequestMapping("/admin/open_wxnative/recommend")
	...
	@RequestMapping("/admin/open_wxnative/delete")
