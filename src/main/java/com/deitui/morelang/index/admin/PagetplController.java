...
public class PagetplController {
	...
	@RequestMapping("/admin/pagetpl/index")
	public String Index() {
	...
	@RequestMapping("/admin/pagetpl/show")
	public String Show(
	...
	@RequestMapping("/admin/pagetpl/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/pagetpl/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("tpl", tpl);
	...
	@RequestMapping("/admin/pagetpl/status")
	...
	@RequestMapping("/admin/pagetpl/recommend")
	...
	@RequestMapping("/admin/pagetpl/delete")
