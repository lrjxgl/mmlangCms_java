...
public class BlacklistPostController {
	...
	@RequestMapping("/admin/blacklist_post/index")
	public String Index() {
	...
	@RequestMapping("/admin/blacklist_post/show")
	public String Show(
	...
	@RequestMapping("/admin/blacklist_post/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/blacklist_post/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("etime", etime);
	...
	@RequestMapping("/admin/blacklist_post/status")
	...
	@RequestMapping("/admin/blacklist_post/recommend")
	...
	@RequestMapping("/admin/blacklist_post/delete")
