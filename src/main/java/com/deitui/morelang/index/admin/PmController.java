...
public class PmController {
	...
	@RequestMapping("/admin/pm/index")
	public String Index() {
		PmModel am=new PmModel();
		String where=" 1 ";
...
indata.put("content", content);
	...
	@RequestMapping("/admin/pm/status")
	...
	@RequestMapping("/admin/pm/recommend")
	...
	@RequestMapping("/admin/pm/delete")
