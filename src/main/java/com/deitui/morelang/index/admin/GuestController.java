...
public class GuestController {
	...
	@RequestMapping("/admin/guest/index")
	public String Index() {
	...
	@RequestMapping("/admin/guest/show")
	public String Show(
	...
	@RequestMapping("/admin/guest/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/guest/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("content", content);
	...
	@RequestMapping("/admin/guest/status")
	...
	@RequestMapping("/admin/guest/recommend")
	...
	@RequestMapping("/admin/guest/delete")
