...
import com.deitui.morelang.index.model.OpenQqModel;
import com.model.Help;

@RestController
@CrossOrigin("*")
public class OpenQqController {
	
	@RequestMapping("/admin/open_qq/index")
	public String Index() {
		OpenQqModel am=new OpenQqModel();
		String where=" 1 ";
	...
	@RequestMapping("/admin/open_qq/show")
	public String Show(
	...
	@RequestMapping("/admin/open_qq/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/open_qq/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("openlogin", openlogin);
	...
	@RequestMapping("/admin/open_qq/status")
	...
	@RequestMapping("/admin/open_qq/recommend")
	...
	@RequestMapping("/admin/open_qq/delete")
