...
public class WeixinSucaiController {
	...
	@RequestMapping("/admin/weixin_sucai/index")
	public String Index() {
	...
	@RequestMapping("/admin/weixin_sucai/show")
	public String Show(
	...
	@RequestMapping("/admin/weixin_sucai/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/weixin_sucai/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("linkurl", linkurl);
	...
	@RequestMapping("/admin/weixin_sucai/status")
	...
	@RequestMapping("/admin/weixin_sucai/recommend")
	...
	@RequestMapping("/admin/weixin_sucai/delete")
