...
public class InviteAccountController {
	...
	@RequestMapping("/admin/invite_account/index")
	public String Index() {
	...
	@RequestMapping("/admin/invite_account/show")
	public String Show(
	...
	@RequestMapping("/admin/invite_account/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="userid",defaultValue="0") int userid
	) {
	...
	@RequestMapping("/admin/invite_account/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="userid",defaultValue="0") int userid,
...
indata.put("income", income);
	...
	@RequestMapping("/admin/invite_account/status")
	...
	@RequestMapping("/admin/invite_account/recommend")
	...
	@RequestMapping("/admin/invite_account/delete")
