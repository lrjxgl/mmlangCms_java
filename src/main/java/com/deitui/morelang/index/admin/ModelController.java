...
public class ModelController {
	...
	@RequestMapping("/admin/model/index")
	public String Index() {
	...
	@RequestMapping("/admin/model/show")
	public String Show(
	...
	@RequestMapping("/admin/model/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/model/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("data", data);
	...
	@RequestMapping("/admin/model/status")
	...
	@RequestMapping("/admin/model/recommend")
	...
	@RequestMapping("/admin/model/delete")
