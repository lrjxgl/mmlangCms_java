...
public class OpenAlipayController {
	...
	@RequestMapping("/admin/open_alipay/index")
	public String Index() {
	...
	@RequestMapping("/admin/open_alipay/show")
	public String Show(
	...
	@RequestMapping("/admin/open_alipay/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/open_alipay/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("merchant_private_key", merchant_private_key);
	...
	@RequestMapping("/admin/open_alipay/status")
	...
	@RequestMapping("/admin/open_alipay/recommend")
	...
	@RequestMapping("/admin/open_alipay/delete")
