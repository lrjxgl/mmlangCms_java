...
public class SiteCityModel extends Model {
	public SiteCityModel() {
		this.preTable=this.table_pre+"site_city";
	}
	...
	public List Dselect() {
	 ...
	 public List getListByIds(ArrayList ids,String fields) {
		...
		List list=this.fields(fields).where(" sc_id in("+idStr+") ").Dselect();
		return list;
    }
}
