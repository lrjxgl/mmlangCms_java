...
public class TableDataController {
	...
	@RequestMapping("/table_data/index")
	public String Index() {
	...
	@RequestMapping("/table_data/show")
	public String Show(
	...
	@RequestMapping("/table_data/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("content", content);
	...
	@RequestMapping("/table_data/status")
	...
	@RequestMapping("/table_data/recommend")
	...
	@RequestMapping("/table_data/delete")
