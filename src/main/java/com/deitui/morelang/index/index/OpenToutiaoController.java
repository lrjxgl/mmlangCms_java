...
public class OpenToutiaoController {
	...
	@RequestMapping("/open_toutiao/index")
	public String Index() {
	...
	@RequestMapping("/open_toutiao/show")
	public String Show(
	...
	@RequestMapping("/open_toutiao/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/open_toutiao/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("openlogin", openlogin);
	...
	@RequestMapping("/open_toutiao/status")
	...
	@RequestMapping("/open_toutiao/recommend")
	...
	@RequestMapping("/open_toutiao/delete")
