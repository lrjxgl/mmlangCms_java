...
public class TixianLogController {
	...
	@RequestMapping("/tixian_log/index")
	public String Index() {
	...
	@RequestMapping("/tixian_log/show")
	public String Show(
	...
	@RequestMapping("/tixian_log/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("admin_id", admin_id);
	...
	@RequestMapping("/tixian_log/status")
	...
	@RequestMapping("/tixian_log/recommend")
	...
	@RequestMapping("/tixian_log/delete")
