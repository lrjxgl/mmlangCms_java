...
public class OpenAlipayMiniController {
	...
	@RequestMapping("/open_alipay_mini/index")
	public String Index() {
	...
	@RequestMapping("/open_alipay_mini/show")
	public String Show(
	...
	@RequestMapping("/open_alipay_mini/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/open_alipay_mini/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("merchant_private_key", merchant_private_key);
	...
	@RequestMapping("/open_alipay_mini/status")
	...
	@RequestMapping("/open_alipay_mini/recommend")
	...
	@RequestMapping("/open_alipay_mini/delete")
