...
public class ExpressFeeController {
	...
	@RequestMapping("/express_fee/index")
	public String Index() {
	...
	@RequestMapping("/express_fee/show")
	public String Show(
	...
	@RequestMapping("/express_fee/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/express_fee/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("amoney", amoney);
	...
	@RequestMapping("/express_fee/status")
	...
	@RequestMapping("/express_fee/recommend")
	...
	@RequestMapping("/express_fee/delete")
