...
public class AdminGroupController {
	...
	@RequestMapping("/admin_group/index")
	public String Index() {
	...
	@RequestMapping("/admin_group/show")
	public String Show(
	...
	@RequestMapping("/admin_group/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("content", content);
	...
	@RequestMapping("/admin_group/status")
	...
	@RequestMapping("/admin_group/recommend")
	...
	@RequestMapping("/admin_group/delete")
