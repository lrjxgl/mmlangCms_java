...
public class OpenBaiduController {
	...
	@RequestMapping("/open_baidu/index")
	public String Index() {
	...
	@RequestMapping("/open_baidu/show")
	public String Show(
	...
	@RequestMapping("/open_baidu/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("openlogin", openlogin);
	...
	@RequestMapping("/open_baidu/status")
	...
	@RequestMapping("/open_baidu/recommend")
	...
	@RequestMapping("/open_baidu/delete")
