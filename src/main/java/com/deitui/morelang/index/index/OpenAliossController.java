...
public class OpenAliossController {
	...
	@RequestMapping("/open_alioss/index")
	public String Index() {
	...
	@RequestMapping("/open_alioss/show")
	public String Show(
	...
	@RequestMapping("/open_alioss/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/open_alioss/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("status", status);
	...
	@RequestMapping("/open_alioss/status")
	...
	@RequestMapping("/open_alioss/recommend")
	...
	@RequestMapping("/open_alioss/delete")
