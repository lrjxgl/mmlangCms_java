...
public class UserBlackController {
	...
	@RequestMapping("/user_black/index")
	public String Index() {
	...
	@RequestMapping("/user_black/show")
	public String Show(
	...
	@RequestMapping("/user_black/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
@RequestParam(value="buserid",defaultValue="0") int buserid
	...
	@RequestMapping("/user_black/status")
	...
	@RequestMapping("/user_black/recommend")
	...
	@RequestMapping("/user_black/delete")
