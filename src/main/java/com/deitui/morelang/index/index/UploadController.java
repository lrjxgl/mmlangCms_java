        ...
        try {
            ...
            if(thumb.equals("") || thumb.equals("100")) {
            	Thumbnails.of(rootImgurl)
            		.size(160, 160)
            		.toFile(rootImgurl+".100x100.png");
            	Oos.upload(rootPath+"/"+imgurl+".100x100.png"); 
            }
            if(thumb.equals("")) {
            	Thumbnails.of(rootImgurl)
	        		.size(480, 480)
	        		.toFile(rootImgurl+".small.png");
            	Oos.upload(rootPath+"/"+imgurl+".small.png"); 
            	Thumbnails.of(rootImgurl)
	        		.size(750, 750)
	        		.toFile(rootImgurl+".middle.png");
            	Oos.upload(rootPath+"/"+imgurl+".middle.png");
            }
