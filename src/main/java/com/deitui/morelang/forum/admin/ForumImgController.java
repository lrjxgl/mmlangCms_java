...
import com.deitui.morelang.forum.model.ForumImgModel;
...
public class ForumImgController {
	...
	@RequestMapping("/admin/forum_img/index")
	public String Index() {
		ForumImgModel am=new ForumImgModel();
		String where=" 1 ";
	...
	@RequestMapping("/admin/forum_img/show")
	public String Show(
	...
	@RequestMapping("/admin/forum_img/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/forum_img/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("imgurl", imgurl);
	...
	@RequestMapping("/admin/forum_img/status")
	...
	@RequestMapping("/admin/forum_img/recommend")
	...
	@RequestMapping("/admin/forum_img/delete")
